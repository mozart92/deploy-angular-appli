...
@Injectable()
export class SourceContaminationGuard implements CanActivate{

  private namePage: String = "Source de contamination";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Source de contamination" : "";
  }
