...
@Injectable()
export class SystemProductionGuard implements CanActivate{

  private namePage: String = "Systeme de production";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Systeme de production" : "";
  }
