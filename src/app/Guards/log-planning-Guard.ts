...
@Injectable()
export class LogPlanningGuard implements CanActivate{

  private namePage: String = "Programme acherve";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Programme acherve" : "planifications achervees";
  }
