...
@Injectable()
export class GstCommune implements CanActivate{

  private namePage: String = "Gestion Arrondissements";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Arrondissements" : "Gestion Communes";
  }
