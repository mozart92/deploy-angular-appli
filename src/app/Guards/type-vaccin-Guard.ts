...
@Injectable()
export class TypeVaccinGuard implements CanActivate{

  private namePage: String = "Gestion Type de vaccins";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Type de vaccins" : "";
  }
