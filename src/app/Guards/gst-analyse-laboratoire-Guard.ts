...
@Injectable()
export class GstAnalyseLaboratoireGuard implements CanActivate {
  private namePage: String = "Type analyse laboratoire";

  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Type analyse laboratoire" : "";
