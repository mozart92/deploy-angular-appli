...
@Injectable()
export class GstGroupes implements CanActivate{

  private namePage: String = "Gestion Groupes utilisateurs";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Groupes utilisateurs" : "Gestion Groupes utilisateurs";
  }
