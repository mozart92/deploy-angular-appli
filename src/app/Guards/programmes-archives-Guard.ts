...
@Injectable()
export class ProgrammesArchivesGuard implements CanActivate{

  private namePage: String = "Programme Archivees";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Programme Archivees" : "planifications archivees";
  }
