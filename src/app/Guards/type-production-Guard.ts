...
@Injectable()
export class TypeProductionGuard implements CanActivate{

  private namePage: String = "Gestion Type de production";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Type de production" : "";
  }
