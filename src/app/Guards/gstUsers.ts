...
@Injectable()
export class GstUsers implements CanActivate{

  private namePage: String = "Gestion Utilisateurs";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Utilisateurs" : "Gestion Utilisateurs";
  }
