...
@Injectable()
export class GstDepartement implements CanActivate{

  private namePage: String = "Gestion Departements";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Departements" : "Gestion Departements";
  }
