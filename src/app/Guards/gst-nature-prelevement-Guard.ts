...
@Injectable()
export class GstNaturePrelevementGuard implements CanActivate{

  private namePage: String = "Gestion Nature prelevement";


  constructor(private servicePrivil: ProfilGroupService, private route : Router, private mode : ModeProductionService) {
    this.namePage = mode.MODE == "cahis" ? "Gestion Nature prelevement" : "";
  }
