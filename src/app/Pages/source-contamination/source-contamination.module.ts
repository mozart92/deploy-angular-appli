...
import {SourceContaminationRoutingModule} from './source-contamination-routing.module';
...
@NgModule({
  imports: [
    ...
    SourceContaminationRoutingModule, PageTitleModule, LoadingModule, Ng2SearchPipeModule,
...
export class SourceContaminationModule { }
