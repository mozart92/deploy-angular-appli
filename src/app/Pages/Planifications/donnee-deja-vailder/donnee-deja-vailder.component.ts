...
@Component({
  selector: 'app-donnee-deja-vailder',
  templateUrl: './donnee-deja-vailder.component.html',
  styleUrls: ['./donnee-deja-vailder.component.sass'],
...
export class DonneeDejaVailderComponent implements OnInit, OnDestroy {

  heading = 'Visualisation de vos données déja validées. Compte : ' + localStorage.getItem('token');
  subheading = 'visualiser';
  ...
  ngOnInit() {
    ...
    this.servicedate.getDonneeDejaValidees().subscribe(
      (datas) => {
        ...
        this.servicedate.NOTIFICATION_DATA_DEJA_SEND = (<AnwserQuestions[]>datas).length;
        this.listDataSend = [];
