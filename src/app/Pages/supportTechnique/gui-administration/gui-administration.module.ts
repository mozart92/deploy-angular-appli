...
import {GuiAdministrationRoutingModule} from './gui-administration-routing.module';
...
@NgModule({
  imports: [
    ...
    GuiAdministrationRoutingModule, PageTitleModule
  ],
...
export class GuiAdministrationModule { }
