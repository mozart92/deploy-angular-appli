...
import {GstPathologiesRoutingModule} from './gst-pathologies-routing.module';
...
@NgModule({
  imports: [
    ...
    GstPathologiesRoutingModule, PageTitleModule, LoadingModule, Ng2SearchPipeModule,
...
export class GstPathologiesModule { }
