...
import {GstAnalyseLaboratoireRoutingModule} from './gst-analyse-laboratoire-routing.module';
...
@NgModule({
  imports: [
    ...
    GstAnalyseLaboratoireRoutingModule, PageTitleModule, LoadingModule, Ng2SearchPipeModule,
...
export class GstAnalyseLaboratoireModule { }
