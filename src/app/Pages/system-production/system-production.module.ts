...
import {SystemProductionRoutingModule} from './system-production-routing.module';
...
@NgModule({
  imports: [
    ...
    SystemProductionRoutingModule, PageTitleModule, LoadingModule, Ng2SearchPipeModule,
