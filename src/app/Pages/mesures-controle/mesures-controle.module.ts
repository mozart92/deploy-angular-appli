...
import {MesuresControleRoutingModule} from './mesures-controle-routing.module';
...
@NgModule({
  imports: [
    ...
    MesuresControleRoutingModule, PageTitleModule, LoadingModule, Ng2SearchPipeModule,
...
export class MesuresControleModule { }
